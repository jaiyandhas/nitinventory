...
export const prApi = {
  ...
  sendBack: (id: number, reason: string) => api.post(`/pr/${id}/send-back`, { reason }),
...
export const adminApi = {
  ...
  createBudget: (data: FormData) => api.post('/admin/budget', data, { headers: { 'Content-Type': 'multipart/form-data' } }),
  ...
  resetAaWorkflow: (data: { category_id: number | null; procurement_id: number | null; purchase_type: string | null; source_of_fund_id?: number | null }) => api.post('/admin/aa-workflows/reset-defaults', data),
