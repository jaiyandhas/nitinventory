        ...
        for proc in procs:
            ...
            if "cat2" in proc_cats:
                ...
                rows.extend([
                    ...
                    step(cat2, "TD", 4, "faculty", "purchase_initiator", "faculty", ptype, proc),
                    step(cat2, "TD", 5, "verifier_da", "verifier_da", "dealing_assistant", ptype, proc),
                    step(cat2, "TD", 6, "verifier_sp", "verifier", "superintendent", ptype, proc),
                    step(cat2, "TD", 7, "faculty", "purchase_initiator", "faculty", ptype, proc),
                    step(cat2, "TD", 8, "verifier_sp", "verifier", "consultant_sp", ptype, proc),
                    step(cat2, "TD", 9, "verifier_sp", "approver", "assistant_registrar", ptype, proc),
            ...
            if "cat3" in proc_cats:
                ...
                rows.extend([
                    ...
                    step(cat3, "TD", 4, "faculty", "purchase_initiator", "faculty", ptype, proc),
                    step(cat3, "TD", 5, "verifier_da", "verifier_da", "dealing_assistant", ptype, proc),
                    step(cat3, "TD", 6, "verifier_sp", "verifier", "superintendent", ptype, proc),
                    step(cat3, "TD", 7, "faculty", "purchase_initiator", "faculty", ptype, proc),
                    step(cat3, "TD", 8, "verifier_sp", "verifier", "consultant_sp", ptype, proc),
                    step(cat3, "TD", 9, "verifier_sp", "approver", "assistant_registrar", ptype, proc),
                    # partial_approver: Dean reviews whether Director approval is needed.
